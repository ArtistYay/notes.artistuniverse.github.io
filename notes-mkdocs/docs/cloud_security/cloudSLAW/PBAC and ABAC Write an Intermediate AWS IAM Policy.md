...
![screenshot](../../../images/Pasted image 20250322183348.png)
...
- Conditionals in IAM policies have two main components:
		1. Condition Keys apply across anything (e.g., aws:SourceIp) or apply to particular services (e.g., `s3:ResourceTag`).
			a. [AWS Documentation](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_condition-keys.html?utm_source=slaw.securosis.com&utm_medium=referral&utm_campaign=pbac-and-abac-write-an-intermediate-aws-iam-policy)
		2. Condition operators are logical conditions like StringEquals, IpAddress, Booleans.
			a. [AWS Documentation](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition_operators.html?utm_source=slaw.securosis.com&utm_medium=referral&utm_campaign=pbac-and-abac-write-an-intermediate-aws-iam-policy)
