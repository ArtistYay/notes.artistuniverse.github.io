...
Attacks can range from being sophisticated to a very simple misconfiguration. Having a good understanding of attack vectors can help in the threat detection process of making rules. Knowing how to use ATT&CK to focus on TTPs is best practice.

# How to read the MITRE ATT&CK framework

Before we get into the matrix we have to understand TTPs:
	Tactics: what is the goal of the attack? are they trying to achieve initial access or do they want to do lateral movement?
